...
/**
 * Modelo Eloquent para la gestión de empleados
 *
 * Representa la entidad Empleado en el sistema con sus atributos y relaciones.
 * 
 ...
 * @property int $id_puesto_trabajo
...
class Empleado extends Model
{
     ...
     */
    protected $table = 'empleados'; // Nombre de la tabla en la BD
     ...
     */
    public $timestamps = true; // Desactivar timestamps de Laravel
    ...
    /**
     * Relación con el usuario que creó el registro del empleado
     *
